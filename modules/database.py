...
def init_db():
    ...
    if c.fetchone()[0] == 0:
        # Defaultni admin ako je baza prazna (koristimo hash za 'admin123' direktno ovdje ili uvozimo utils, 
        # ali radi jednostavnosti hardcodirat ćemo hash za admin123 da izbjegnemo cirkularni import)
